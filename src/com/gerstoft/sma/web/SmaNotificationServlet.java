...
public class SmaNotificationServlet extends DataSourceServlet {
	...
	private static final String[] COUNTRY_SYMBOLS = "EGPT EWI EDEN EWP EWK EIRL EPI EWQ EIS EZA EWL EWG EWA SPY QQQ EPOL EWC EWU PGJ EWY EWT EWN EWD EWZ GXG EWO IWM EWH IDX EWS EIDO EWM THD TUR GXC FXI EPU EWW JPP EWJ BRF ECH RSX RBL"
			.split(" ");
